...
<?php if ( apply_filters( 'urestaurant_home_show_feature_section', in_array( 'feature', $visible_sections ) ) ) : ?>
    <section class="feature_wrap v2" style="background-image: url(<?php get_field( 'background-feature' ) ? esc_attr( the_field( 'background-feature' ) ) : ''; ?>);">
        ...
        <div class="container">
            <img src="<?php echo urestaurany_get_attachment_url_by_title("{$template_name}-shape_4"); ?>" alt="Image" class="abs_img_7" />
            <div class="row">
                    ...
                    <div class="feature_text_wrap">
                        <div class="feature_text">
                            ...
                            <?php if ( get_field( 'button-text-feature' ) ) : ?>
                                <a href="<?php get_field( 'button-link-feature' ) ? esc_attr( the_field( 'button-link-feature' ) ) : ''; ?>" class="btn v1"><?php esc_html( the_field( 'button-text-feature' ) ); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
