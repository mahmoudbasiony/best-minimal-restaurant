...
<?php if ( apply_filters( 'urestaurant_contact_show_breadcrumb_section', in_array( 'breadcrumb', $visible_sections ) ) ) : ?>
    <section class="breadcrumb_wrap v3" style="background-image: url(<?php get_field( 'background-breadcrump-contact' ) ? esc_url( the_field( 'background-breadcrump-contact' ) ) : ''; ?>);">
