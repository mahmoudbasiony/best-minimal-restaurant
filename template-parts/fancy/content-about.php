                ...
                <div class="col-md-12">
                    <div class="promo_video" style="background-image: url(<?php get_field( 'video-background-image' ) ? esc_url( the_field( 'video-background-image' ) ) : ''; ?>);">
                        ...
                        <div class="video_btn">
                            ...
                            ?>
                                <a href="<?php echo esc_url( $url ); ?>" class="play_btn hvr-ripple-out"><img src="<?php echo URESTAURANT_THEME_URI; ?>/assets/img/<?php echo esc_html( $template_name ); ?>/play.png" alt="Image"></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
